package com.example.docadmin.Screens.SignUp
...
@Composable
fun SignUpScreen(navController: NavHostController,authViewModel: AuthViewModel,userViewModel: UserViewModel) {
    ...
    Surface(
        ...
        Column(
            ...
            Box(
                ...
                SignUpSection(navController,userViewModel, context = LocalContext.current,authViewModel)
            }
...
@Composable
private fun SignUpSection(navController: NavHostController, UserViewModel: UserViewModel,context: Context,authViewModel: AuthViewModel) {
        ...
        Button(
            ...
            onClick = {
                ...
                if (isFormValid) {
                    ...
                    UserViewModel.createUser(name, age, phoneNumber, email, password,context)
